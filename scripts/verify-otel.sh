...
for svc in "gateway-service" "auth-server"; do
...
for container in "macs-gateway-service" "macs-auth-server"; do
...
for target in "gateway-service:8080" "auth-server:9000"; do
  SVC="${target%%:*}"
  PORT="${target##*:}"
