        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <div className="flex items-start justify-between mb-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 flex-1">
              <div>
                <span className="text-[10px] uppercase tracking-wider text-gray-400">ID (Route)</span>
    ...
    <div>
      ...
      <div className="mb-4">
        <input
          ...
          placeholder="id, title, description으로 검색..."
              ...
              >
                ...
                <div className="px-4 py-3 space-y-2">
                  <div>
                    ...
                    <p className="text-sm font-mono text-gray-700">{c.id}</p>
                  </div>
                  {c.description && (
                    <div>
                      <span className="text-[10px] uppercase tracking-wider text-gray-400">Description</span>
